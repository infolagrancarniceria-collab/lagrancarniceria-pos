...
import { obtenerImpresoraBoletas, setImpresoraBoletas } from "../lib/impresoras";
    ...
    <div>
      ...
      {window.electronAPI && (
        <section className="tarjeta">
          <h2>Impresoras</h2>
          <p className="ayuda">
            Elige qué impresora usar para las boletas en <strong>este PC</strong>. Si dejas "La predeterminada de
