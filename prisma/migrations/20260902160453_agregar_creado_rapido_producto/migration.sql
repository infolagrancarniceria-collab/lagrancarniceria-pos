...
INSERT INTO "new_Producto" ("activo", "actualizadoEn", "aplicaIvaCarne", "capacidadPorCaja", "categoriaId", "codigoBarras", "codigoProveedor", "contenido", "costoReferencia", "creadoEn", "descripcion", "descripcionCorta", "disponibilidadWeb", "duracion", "envase", "esCombo", "familiaCorte", "featured", "flagBalanza", "id", "impuestoAdicional", "lowStock", "marca", "nombreCorto", "pesoPromedioTrozoGramos", "plu", "precio", "precioMayor", "promoEtiqueta", "promoGramosMinimos", "promoPrecioUnitario", "stockActual", "umbralStockBajo", "visibleEnWeb") SELECT "activo", "actualizadoEn", "aplicaIvaCarne", "capacidadPorCaja", "categoriaId", "codigoBarras", "codigoProveedor", "contenido", "costoReferencia", "creadoEn", "descripcion", "descripcionCorta", "disponibilidadWeb", "duracion", "envase", "esCombo", "familiaCorte", "featured", "flagBalanza", "id", "impuestoAdicional", "lowStock", "marca", "nombreCorto", "pesoPromedioTrozoGramos", "plu", "precio", "precioMayor", "promoEtiqueta", "promoGramosMinimos", "promoPrecioUnitario", "stockActual", "umbralStockBajo", "visibleEnWeb" FROM "Producto";
DROP TABLE "Producto";
