...
INSERT INTO "new_Producto" ("activo", "actualizadoEn", "aplicaIvaCarne", "capacidadPorCaja", "categoriaId", "codigoBarras", "codigoProveedor", "contenido", "costoReferencia", "creadoEn", "descripcion", "duracion", "envase", "flagBalanza", "id", "impuestoAdicional", "marca", "nombreCorto", "plu", "precio", "precioMayor", "stockActual", "umbralStockBajo") SELECT "activo", "actualizadoEn", "aplicaIvaCarne", "capacidadPorCaja", "categoriaId", "codigoBarras", "codigoProveedor", "contenido", "costoReferencia", "creadoEn", "descripcion", "duracion", "envase", "flagBalanza", "id", "impuestoAdicional", "marca", "nombreCorto", "plu", "precio", "precioMayor", "stockActual", "umbralStockBajo" FROM "Producto";
DROP TABLE "Producto";
